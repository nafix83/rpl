<div class="my-5 mx-5 border-rounded-full">
    <div class="bg-gray-300">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <div class="text-xl font-bold">Nama Barang</div>
                <div class="text-sm">Stok</div>
            </div>
            <div class="ml-auto flex space-x-10">
                <button class="bg-white text-black hover:bg-blue-600 hover:text-white font-bold py-2 px-10 rounded text-lg">Edit</button>
