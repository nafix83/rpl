...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Login Vanguard Solution Indonesia</title>
        ...
        <style>
            #form {
                ...
                backdrop-filter: blur(10px) brightness(97%);
                -webkit-backdrop-filter: blur(10px) brightness(97%);
            }
        </style>
    </head>
    <body class="antialiased bg-cover bg-center login-bg" style="background-image: url('imgLogin/login.jpg')">
